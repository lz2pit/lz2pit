  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 pb-12">
        ...
        {!showResults ? (
          // ФОРМА ЗА ВЪВЕЖДАНЕ - показва се само когато няма резултати
          ...
          // РЕЗУЛТАТИ - показват се на цял екран когато има данни
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="text-center">
              <Button
                ...
                variant="outline"
                className="bg-white/90 backdrop-blur-sm border-2 border-blue-200 hover:bg-blue-50"
              >
                ← Нови изчисления
              </Button>
            </div>

            {/* НАТАЛНА КАРТА И ТАБЛИЦИ В КОМПАКТЕН ВАРИАНТ */}
            <div className="grid lg:grid-cols-2 gap-6">
              
              {/* Натална карта и планети */}
